...
fred = Unicorn.new(name: "fred", gender: "male", age: 11, color: "white", price: "500_000", variety: "Murder", team_member: true, user: owner)
...
marcela = Unicorn.new(name: "marcela", gender: "female", age: 5, color: "white", price: "250_000", variety: "Cute", team_member: true, user: owner)
...
grace = Unicorn.new(name: "grace", gender: "female", age: 3, color: "white", price: "300_000", variety: "Haunted", team_member: true, user: owner)
...
audrey = Unicorn.new(name: "audrey", gender: "female", age: 6, color: "pink", price: "20_000", variety: "Cute", team_member: true, user: owner)
...
david = Unicorn.new(name: "david", gender: "female", age: 6, color: "white", price: "10_000", variety: "Haunted", team_member: true, user: owner)
david.photo.attach(io: david_photo, filename: "david.png", content_type: "image/jpg")
david.save

https://th.bing.com/th/id/OIG.OBV21STN_e_tiWqVnrrp?pid=ImgGn
sergio_photo = URI.open("https://th.bing.com/th/id/OIG.OBV21STN_e_tiWqVnrrp?pid=ImgGn")
sergio = Unicorn.new(name: "sergio", gender: "female", age: 6, color: "green", price: "50_000", variety: "Cute", team_member: true, user: owner)
