...
seb = Unicorn.new(name: "seb", gender: "male", age: 7, color: "gold", price: "1_000_000", variety: "Bulky", team_member: true, user: owner)
...
fred = Unicorn.new(name: "fred", gender: "male", age: 11, color: "white", price: "500_000", variety: "Murder", team_member: false, user: owner)
...
marcela = Unicorn.new(name: "marcela", gender: "female", age: 5, color: "white", price: "250_000", variety: "Cute", team_member: false, user: owner)
...
audrey = Unicorn.new(name: "audrey", gender: "female", age: 6, color: "pink", price: "20_000", variety: "Cute", team_member: false, user: owner)
...
david = Unicorn.new(name: "david", gender: "female", age: 9, color: "white", price: "10_000", variety: "Murder", team_member: false, user: owner)
...
sergio = Unicorn.new(name: "sergio", gender: "male", age: 5, color: "green", price: "50_000", variety: "Cute", team_member: false, user: owner)
...
justin = Unicorn.new(name: "justin", gender: "male", age: 10, color: "white", price: "70_000", variety: "Haunted", team_member: false, user: owner)
...
grant = Unicorn.new(name: "grant", gender: "male", age: 3, color: "pink", price: "15_000", variety: "Barbie", team_member: false, user: owner)
...
kitty = Unicorn.new(name: "kitty", gender: "female", age: 3, color: "pink", price: "15_000", variety: "Haunted", team_member: false, user: owner)
...
marcelo = Unicorn.new(name: "marcelo", gender: "male", age: 3, color: "pink", price: "15_000", variety: "Bulky", team_member: false, user: owner)
